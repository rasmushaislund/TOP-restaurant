...
export function createAbout() {
  ...
  sectionOne.append(sectionOneHeader, sectionOnePara);
  sectionTwo.append(sectionTwoHeader, sectionTwoPara);
  sectionThree.append(sectionThreeHeader, sectionThreePara);
  about.append(sectionOne, sectionTwo, sectionThree);
